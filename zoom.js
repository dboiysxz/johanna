function imageZoom(img) {
    var lens = document.querySelectorAll('.slide[data-active] .lens')[0]
...
function updateFeaturedImageForZoom() {
    var currentSlide = document.querySelectorAll('.slide[data-active] img')[0];
    imageZoom(currentSlide)
}

document.addEventListener('carousel-nav-button-clicked', updateFeaturedImageForZoom);
window.addEventListener('resize', updateFeaturedImageForZoom);
updateFeaturedImageForZoom();
